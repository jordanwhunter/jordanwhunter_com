...
const Contact = () => {
  ...
  return (
    ...
    >
      ...
      <p className='text-gray-400 text-center lg:text-left -mt-4'>Email directly at <a className='underline' href='mailto:jordanwhunter.mail@gmail.com'>jordanwhunter.mail@gmail.com</a> or use form below.</p>
      <Form />
    </motion.section>
  )
}
